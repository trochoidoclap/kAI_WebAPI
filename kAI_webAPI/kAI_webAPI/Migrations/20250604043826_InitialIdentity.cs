    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_questype = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Questype = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Comment = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Comment_vn = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions_type", x => x.Id_questype);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subjects", x => x.Id_subjects);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_subgroup = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ...
                    Subject4 = table.Column<int>(type: "int", nullable: true),
                    Subject5 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_subjects_group", x => x.Id_subgroup);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subjects_group_Subject1",
                table: "subjects_group",
                column: "Subject1");

            migrationBuilder.CreateIndex(
                name: "IX_subjects_group_Subject2",
                table: "subjects_group",
                column: "Subject2");

            migrationBuilder.CreateIndex(
                name: "IX_subjects_group_Subject3",
                table: "subjects_group",
                column: "Subject3");

            migrationBuilder.CreateIndex(
                name: "IX_subjects_group_Subject4",
                table: "subjects_group",
                column: "Subject4");

            migrationBuilder.CreateIndex(
                name: "IX_subjects_group_Subject5",
                table: "subjects_group",
                column: "Subject5");
        }
